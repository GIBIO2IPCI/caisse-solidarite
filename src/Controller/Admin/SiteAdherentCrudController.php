...
class SiteAdherentCrudController extends AbstractCrudController
{
    public static function getEntityFqcn(): string
    {
        return SiteAdherent::class;
    }
    ...
    public function configureActions(Actions $actions): Actions
    {
        return $actions
            ...
            ->update(Crud::PAGE_INDEX, Action::DELETE,
                ...
                fn (Action $action) => $action->setLabel("Ajouter un site")
            )
            ->update(Crud::PAGE_NEW, Action::SAVE_AND_RETURN,
                fn (Action $action) => $action->setLabel("Enregistrer")
            )
            ->update(Crud::PAGE_NEW, Action::SAVE_AND_ADD_ANOTHER,
                fn (Action $action) => $action->setLabel("Enregistrer et ajouter un autre site")
            )
            ;
    }
    ...
    public function configureCrud(Crud $crud): Crud
    {
        return $crud
         ...
         ->setPageTitle('index', 'Liste des sites')
            ;
    }
}
